	...
	private function setArrCmpLlaveModAgr(){
		$this->arr_cmp_llave_val = array(
			'tipo_cultivo'=>array(
				...
				5=>'Arroz',
				6=>'Sorgo',
				7=>'Otro(s) grano(s) -> por favor mencione cuál(es)',
				8=>'Frijol y otras vainas o legumbres',
				9=>'Soya',
				10=>'Papa y/u otros tubérculos (sus rizomas crecen de forma horizontal y el producto o cultivo se puede replantar, como el jengibre)',
				11=>'Cultivos de raíz que no son tubérculos (zanahoria, cacahuate, jícama, etc.)',
				12=>'Alfalfa',
				13=>'Forrajes fijadores de nitrógeno',
				14=>'Forrajes no fijadores de nitrógeno',
				15=>'Pastos perennes',
				16=>'Otro(s) cultivo(s)-> por favor mencione cuál(es)',
			),
			'agr_p5rN_tipo'=>array(
				1=>'Diesel',
				2=>'Gasolina',
				3=>'Gas natural',
				4=>'Gas LP',
				5=>'Electricidad de la red',
				6=>'Electricidad de fuentes renovables (solar o eólica)',
				7=>'Combustóleo',
				8=>'Leña',
				9=>'Carbón',
			),
			...
			'agr_p7_pago'=>array(
				1=>'Se dejan en el campo para su reincorporación al suelo',
				2=>'Quema a cielo abierto',
				3=>'Composteo',
				4=>'Alimento de animales',
				5=>'Elaboración de silo',
				6=>'Uso en camas de los animales',
				7=>'Venta',
				8=>'Elaboración de combustible',
				9=>'Se entierran, por ejemplo en fosa sanitaria',
				10=>'Otra ¿Cuál?',
			),
	...
	private function setArrCmpLlaveModPec(){
		$this->arr_cmp_llave_val = array(
			...
			'pec_hato_e1'=>array(
				...
				2=>'Vaquillonas de reemplazo',
				3=>'Vacas doble propósito',
				4=>'Toros para reproducción (sementales)',
				5=>'Bueyes para fuerza de tiro',
				6=>'Terneros antes del destete',
				7=>'Ganado de engorde post-destete',
			),
			'pec_hato_e2'=>array(
				1=>'Vacas adultas',
				2=>'Vaquillonas de reemplazo',
			...
			'pec_hato_e3'=>array(
				1=>'Ovejas adultas para producción de crías',
				2=>'Ovejas adultas para producción de crías y de lana',
				3=>'Ovejas adultas lecheras',
				4=>'Otros ovinos > 1 año',
				5=>'Corderos en crecimiento < 1 año',
			),
			'pec_hato_e4'=>array(
				1=>'Cerdas en gestación',
				2=>'Cerdas en lactancia',
				3=>'Cerdos utilizados como sementales',
				4=>'Lactantes',
				5=>'En crecimiento a finalización',
				6=>'Cerdas en crecimiento que se van a usar con fines reproductivos',
				7=>'Cerdos en crecimiento que se van a usar con fines reproductivos',
			),
			'pec_hato_e5'=>array(
				1=>'Pollos para carne',
			...
			'pec_hato_e6'=>array(
				1=>'Cabras lecheras en producción',
				2=>'Cabras hembras adultas para producir cabrito',
				3=>'Cabras hembras adultas de reemplazo para pie de cría',
				4=>'Machos adultos de reemplazo para pie de cría',
				5=>'Cabritos (machos y hembras) entre 1 y 2 años',
				6=>'Cabritos (machos y hembras) menores de 1 año',
			),
