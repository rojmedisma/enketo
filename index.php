...
include_once 'core/'.CARPETA_PROYECTO.'/CuestBase.class.php';	//Archivo propio del proyecto siap_igei
include_once 'core/'.CARPETA_PROYECTO.'/ModeloValidaBase.class.php';	//Archivo propio del proyecto siap_igei
