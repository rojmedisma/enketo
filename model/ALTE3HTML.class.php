...
class ALTE3HTML{
	...
	public function setHTMLBtnBorrar($controlador_borrar, $accion_borrar, $controlador_actual, $accion_actual, $cmp_id_nom, $cmp_id_val) {
		...
		$arr_tag[] = '	<input type="hidden" name="controlador_fuente" value="'.$controlador_actual.'">';
		$arr_tag[] = '	<input type="hidden" name="accion_fuente" value="'.$accion_actual.'">';
		$arr_tag[] = '	<input type="hidden" name="'.$cmp_id_nom.'" value="'.$cmp_id_val.'">';
